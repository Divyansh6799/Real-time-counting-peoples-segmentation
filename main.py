    ...
    def image_option():
        ...
        def detectByPathImage(path):
            ...
            def img_enumeration_plot():
                ...
                plt.get_current_fig_manager().set_window_title("Plot for Image") #plt.manager.set_window_title("Plot for Image")
                plt.show()
            ...
            def img_accuracy_plot():
                ...
                plt.legend()
                plt.get_current_fig_manager().set_window_title("Plot for Image")
                plt.show()
            ...
            for i in range(len(boxes)):
                ...
                if classes[i] == 1 and scores[i] > threshold:
                    ...
                    if (scores[i] > max_acc1):
                        max_acc1 = scores[i]
            print(person)
            cv2.putText(img, f'Total Person -->{person}', (10, 50), cv2.FONT_HERSHEY_PLAIN,2, (0,255,0), 3)    
    ...
    def video_option():
        ...
        def detectByPathVideo(path, writer):
            ...
            def vid_enumeration_plot():
                ...
                plt.title('Enumeration Plot')
                plt.legend()
                plt.get_current_fig_manager().set_window_title("Plot for Video")
                plt.show()
            ...
            if video.isOpened() is False :
                ...
                exit(0)
            fps_input_stream = int(video.get(5)) # get fps of the hardware
    ...
    def camera_option():
        ...
        def detectByCamera(writer):
            ...
            def cam_enumeration_plot():
                ...
                plt.legend()
                plt.title("Enumeration Plot")
                plt.get_current_fig_manager().set_window_title("Plot for Camera")
                plt.show()
